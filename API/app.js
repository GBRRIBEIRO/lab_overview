...
const classroomReportsRouter = require('./routes/classroomReportRoutes');  //Imports the router with the basic routes and operations
...
app.use('/api/v1/classroomReports', classroomReportsRouter); //Sets the default route || Connects with the route handler
